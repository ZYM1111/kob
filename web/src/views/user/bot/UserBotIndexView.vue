            ...
            <div class="col-9">
                <div class="card">
                    <div class="card-header">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="add-bot-btn" tabindex="-1" aria-labelledby="add-bot-btn"
                            aria-hidden="true">
...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
              url: "https://app7324.acapp.acwing.com.cn/api/user/bot/getlist/",
                type: "GET",
                headers: {
        ...
        const add_bot = () => {
            $.ajax({
              url: "https://app7324.acapp.acwing.com.cn/api/user/bot/add/",
                type: "POST",
                data: {
                    title: botadd.title,
        ...
        const update_bot = (bot) => {
            bot.error_message = "";
            $.ajax({
              url: "https://app7324.acapp.acwing.com.cn/api/user/bot/update/",
                type: "POST",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
              url: "https://app7324.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "POST",
                data: {
                    bot_id: bot.id
                },
